...
int main (int argc, char **argv)
{
  ...
  if(buffer_length < 0)
    {print_conv_err("Queue length (first argument)"); return 0;} 
  if(nr_jobs < 0)
    {print_conv_err("Number of jobs (second argument)"); return 0;} 
  if(nr_producers < 0)
    {print_conv_err("Number of producers (third argument)"); return 0;} 
  if(nr_consumers < 0)
    {print_conv_err("Number of consumers (fourth argument)"); return 0;} 

  
  if(buffer_length < 1)
    {print_limit_err("Queue length (first argument)"); return 0;} 
  if(nr_jobs < 1)
    {print_limit_err("Number of jobs (second argument)"); return 0;} 
